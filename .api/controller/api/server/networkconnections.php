 ...
 *
 */
class Networkconnections extends \Base\Controller
{
    /*
     ...
     * @var int
     */
    private $cache_key = 'networkconnections';
    ...
    /**
     * GET /api/server/network-connections
     *
     * @return void
     */
    public function get()
    {
        try {
            if (!$this->cache->exists($this->cache_key, $this->result)) {
                //
                $this->result = array_values((array) $this->system->netstat('-pant'));
                //
