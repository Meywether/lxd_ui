 ...
 *
 */
class Usb extends \Base\Controller
{
    /*
     * @var
     */
    ...
    public function index(\Base $f3, $params)
    {
        ...
        if ($verb === 'GET') {
            try {
                $result = $this->devices->findAll('type = "usb"');
        ...
        if ($verb === 'POST') {
            ...
            //
            if (empty($body['dict']['vendorid'])) {
                $errors['dict']['vendorid'] = 'Device name cannot be empty';
            }
