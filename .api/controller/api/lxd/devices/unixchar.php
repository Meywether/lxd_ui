 ...
 *
 */
class Unixchar extends \Base\Controller
{
    /*
     * @var
     */
    ...
    public function index(\Base $f3, $params)
    {
        ...
        /**
         * GET /api/lxd/devices/unixchar
         */
        if ($verb === 'GET') {
            try {
                $result = $this->devices->findAll('type = "unix-char"');
    ...
    public function item(\Base $f3, $params)
    {
        ...
        /**
         * GET /api/lxd/devices/unixchar/@id
         */
        if ($verb === 'GET') {
            try {
        ...
        /**
         * POST /api/lxd/devices/unixchar/@id
         */
        if ($verb === 'POST') {
        ...
        /**
         * PUT /api/lxd/devices/unixchar/@id
         */
        if ($verb === 'PUT') {
            $body = json_decode($f3->get('BODY'), true);
        ...
        /**
         * DELETE /api/lxd/devices/unixchar/@id
         */
        if ($verb === 'DELETE') {
            try {
                $result = $this->devices->load($params['id']);
